...
Current content includes files 01 through 39 and 41 through 51. File 40 was not supplied. Collection-level figures originate in supplied editorial copy and have not been independently reconciled against an inventory spreadsheet. Related holdings may overlap. The public register records `verifiedImageCount: null` until source reconciliation is complete. Broad subject collections are not marked as individual historical events. ZIP-batch README notes remain production context and are not published as page copy.
