...
collectionGroups.push({start:130,end:149,id:'jewellery',label:'Jewellery'});
collectionGroups.push({start:150,end:159,id:'kitchen-tableware',label:'Kitchen and tableware'});
...
Object.assign(additionalNames,{140:'Necklaces and chokers, collection I',141:'Necklaces and chokers, collection II',142:'Necklace chains',143:'Necklaces and chokers, collection III',144:'Cross necklaces',145:'Pearl necklaces and the Queen Mother inventory reference',146:'Pendants',147:'Rings and bands',148:'Jewelled rings',149:'Tiaras and fascinators'});
Object.assign(additionalNames,{150:'Kitchen accessories and gadgets',151:'Cooking tools, trivets and equipment',152:'Washing-up brushes, racks and cloths',153:'Cruets, egg cups and toast racks',154:'Cups, saucers, mugs and beakers',155:'Tea and coffee sets',156:'Cutlery and chopsticks',157:'Dishes, bowls and kitchen baskets',158:'Kitchen electrical appliances',159:'Ceramic and glass jugs'});
...
const edits=[
  [/Archive\.London can use those facts confidently while reserving individual brand attribution for documented pieces\./g,'Those career facts provide context; individual brand attribution depends on documentation for each piece.'],
  [/Repetition here is not duplication\. It records new pieces, new arrangements and further ways of translating weight, brilliance and drape into a still image\./g,'The catalogue records this as a separate holding. Its relationship to the other necklace groups remains a subject for image-level comparison.'],
  [/Archive\.London can make that process visible, positioning the collection as photographic heritage and a serious research resource\./g,'The collection offers material for researching photographic process alongside the jewellery itself.'],
  [/Archive\.London should preserve the distinction between photographic authorship and the personal belief or ownership attached to an unidentified cross\./g,'Photographic authorship does not establish the personal belief or ownership associated with an unidentified cross.'],
  [/Captions should remain respectful and evidence-led, avoiding assumptions about denomination, wearer or ritual use\./g,'The category label does not establish a denomination, wearer or ritual use for an individual necklace.'],
  [/Archive\.London should preserve that inventory reference exactly while undertaking frame-level verification before adding claims about ownership, commission, date, occasion or maker\./g,'The inventory reference is retained as catalogue wording. It does not by itself establish ownership, a commission, date, occasion or maker; those details require frame-level research.'],
  [/The strongest presentation will distinguish three layers: what the inventory records, what the frame visibly shows and what later expert research can verify\./g,'Research can distinguish the inventory wording, visible details in the photograph and findings supported by expert examination.'],
  [/That transparency makes Archive\.London more credible and more quotable than an exaggerated royal claim\./g,'The reference remains a starting point for research rather than a confirmed royal provenance.'],
  [/Archive\.London should show complete pieces before macro details, preserving the relationship between pendant and chain\./g,'The relationship between pendant and chain is part of the collection’s research value.'],
  [/It should not be used to attribute an unidentified band, but it legitimately positions the photographer within the high jewellery field\./g,'This career relationship does not establish an attribution for an unidentified band.'],
  [/Archive\.London can credibly position this as a major heritage jewellery resource created by a photographer with verified De Beers experience and elite editorial training\./g,'This jewellery collection sits within Harper’s wider commercial and editorial practice, including his work for De Beers.'],
  [/Archive\.London should present the pieces with glamour and restraint, allowing verified provenance to lead\. The result is more compelling than a speculative royal caption because it invites serious discovery\./g,'The pieces can be researched through their visible design and surviving records. The category does not establish a royal association for an individual headpiece.'],
...
for(const filename of (await fs.readdir('content/source')).sort()){
  ...
  let copy=body.trim();
  const careerIntroductions={'150_':'Harper’s kitchen gadgets sit within a career spanning household products and fashion publishing.','152_':'The washing-up photographs extend Harper’s editorial attention to the practical work behind domestic display.','155_':'The tea and coffee sets connect Harper’s magazine practice with the visual presentation of hospitality.','158_':'Kitchen appliances form part of Harper’s broader work across designed objects and commercial photography.','140_':'The first necklace collection belongs to a practice sustained across fashion magazines and commercial commissions.','147_':'Harper’s ring studies sit within a career spanning editorial publishing and commercial photography.'};
  const careerIntro=Object.entries(careerIntroductions).find(([prefix])=>filename.startsWith(prefix));
  if(careerIntro)copy=copy.replace(/For more than fifteen years he contributed regularly[^\n]+\*\*Montblanc\*\*\./,original=>{
    const replacement=careerIntro[1]+' He worked regularly for **Elle** and **The Telegraph Magazine** for more than fifteen years. Other editorial credits included **Vogue, Tatler, Cosmopolitan, Esquire, The Face, Wallpaper** and **Harpers & Queen**. Across his broader career, confirmed clients included **De Beers, Boots, Heinz, Diageo, Harrods, Selfridges, the BBC, CBS Records** and **Montblanc**.';
    changes.push({file:filename,original,replacement,reason:'Retain supplied career facts with collection-specific context instead of a verbatim repeated paragraph.'});return replacement;
  });
  ...
  const biographyVariants={
    '150_':'The kitchen accessory studies draw on Harper’s studio training. Born in Scotland, he grew up between Glasgow and Islay, received his first camera at seven and sold a photograph of **The Who** in concert at fourteen. He moved to London to study photography and spent two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '151_':'Harper’s cooking-tool photographs belong to a career that began with a camera at seven. He was born in Scotland and raised between Glasgow and Islay; at fourteen he sold a concert photograph of **The Who**. London photography studies were followed by two years at **Condé Nast**, directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '152_':'Behind the washing-up studies is Harper’s progression from early photography in Scotland to professional work in London. Raised between Glasgow and Islay, he received a camera at seven and sold a concert photograph of **The Who** at fourteen. He moved to London to study photography, spending two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '153_':'The breakfast-table collection sits within Harper’s long photographic practice. Born in Scotland and raised between Glasgow and Islay, he began with a camera at seven and sold a concert photograph of **The Who** at fourteen. His move to London brought photography studies and two years at **Condé Nast**, directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '155_':'Harper’s studies of tea and coffee services follow a career rooted in Scotland and developed in London. He grew up between Glasgow and Islay, received his first camera at seven and sold a photograph from a concert by **The Who** at fourteen. After moving to London to study photography, he spent two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '156_':'The cutlery collection belongs to a photographer whose experience began well before his studio career. Harper was born in Scotland and grew up between Glasgow and Islay. He received a camera at seven and sold a concert photograph of **The Who** at fourteen, later moving to London for photography studies and two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '157_':'Harper brought a long photographic background to the bowl and basket studies. Born in Scotland and raised between Glasgow and Islay, he received a camera at seven; a concert photograph of **The Who** became a sale at fourteen. He moved to London to study photography and spent two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '158_':'The appliance photographs sit within Harper’s progression into professional studio work. His childhood was spent between Glasgow and Islay in Scotland, where he received his first camera at seven. At fourteen he sold a concert photograph of **The Who**. He subsequently studied photography in London and spent two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '140_':'The first necklace group reflects a career that began far from the jewellery studio. Born in Scotland and raised between Glasgow and Islay, Harper received his first camera at seven and sold a photograph from a concert by **The Who** at fourteen. He moved to London to study photography before spending two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '142_':'The chain studies belong to a practice rooted in both early observation and studio training. Harper was born in Scotland and grew up between Glasgow and Islay. His first camera arrived at seven; at fourteen he sold a concert photograph of **The Who**. In London he studied photography and spent two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '143_':'Behind the third necklace collection is Harper’s progression from Scotland to the London studio. Raised between Glasgow and Islay, he received a camera at seven and sold a concert photograph of **The Who** at fourteen. Photography studies brought him to London, where he spent two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
    '146_':'Harper’s pendant photographs form part of a career that started in Scotland, where he grew up between Glasgow and Islay. Given a camera at seven, he sold a photograph of **The Who** in concert at fourteen. He later moved to London for photography studies and spent two years at **Condé Nast** directly assisting **David Bailey, Helmut Newton and Lester Bookbinder**.',
