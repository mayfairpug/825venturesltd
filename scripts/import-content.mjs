...
for(const filename of (await fs.readdir('content/source')).sort()){
  ...
  let copy=body.trim();
  const careerIntroductions={'140_':'The first necklace collection belongs to a practice sustained across fashion magazines and commercial commissions.','147_':'Harper’s ring studies sit within a career spanning editorial publishing and commercial photography.'};
